...
$HELPDESK_SUPPORT_EMAIL_ID = 'r.gusseinov@globalinklogistics.com';
...
$dbconfig['db_server'] = getenv('DB_HOST') ?: '127.0.0.1';
$dbconfig['db_port'] = getenv('DB_PORT') ? ':' . getenv('DB_PORT') : ':3306';
$dbconfig['db_username'] = getenv('DB_USERNAME') ?: 'root';
$dbconfig['db_password'] = getenv('DB_PASSWORD') ?: 'securepassword';
$dbconfig['db_name'] = getenv('DB_DATABASE') ?: 'vt7';
$dbconfig['db_type'] = 'mysqli';
$dbconfig['db_status'] = 'true';

$dbconfig['mysqli_ssl'] = true;
$dbconfig['mysqli_ssl_ca'] = 'root.crt'; // Adjust path as needed
...
$application_unique_key = '5b8d7ff1c9a4610b7d54d4eedbc67fc3';
